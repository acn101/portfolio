...
const projectsData = [
    ...
    {
        title: "TBD",
        description: "A third person rogue-like shooter with randomized stages, items, and boss fights solo developed in Unreal Engine. A work in progress so check back soon!",
